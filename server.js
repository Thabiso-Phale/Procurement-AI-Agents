...
var RESEND_FROM       = (process.env.RESEND_FROM || 'ProjectBuys <hello@projectbuys.com>').trim();
...
function sendLicenseEmail(toEmail, licenseKey, plan, cb) {
  ...
  var html = [
    ...
    '<h1 style="color:#fff;font-size:20px;margin:8px 0 4px">Welcome to ProjectBuys ' + planLabel + '!</h1>',
    ...
    '<p style="font-size:14px;color:#475569;margin:0 0 8px">&#49;&#65039;&#8419; Open <a href="https://app.projectbuys.com" style="color:#1D4ED8;font-weight:600">app.projectbuys.com</a></p>',
    ...
    'Need help? Read the <a href="https://app.projectbuys.com/guide" style="color:#3B82F6">Getting Started Guide</a>',
    ' &nbsp;&#183;&nbsp; ',
    '<a href="mailto:support@projectbuys.com" style="color:#3B82F6">support@projectbuys.com</a>',
    '</p>',
    '</div>'
  ].join('');
  ...
  var payload = JSON.stringify({
    from: RESEND_FROM,
    to: [toEmail],
    subject: 'Your ProjectBuys ' + planLabel + ' License Key',
    html: html
  });
...
server.listen(PORT, '0.0.0.0', function() {
  console.log('');
  console.log('  ============================================');
  console.log('   ProjectBuys is running!');
